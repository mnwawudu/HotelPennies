// server.js — production-clean (full)
// ---------------------------------------------------------------
...
// (optional legacy) adminUsersRoutes if you still use it
// const adminUsersRoutes = require('./routes/adminUsers');

// NEW: dedicated admin accounts (fixes “route not found” on Admin Users page)
const adminAccountsRoutes = require('./routes/adminAccountsRoutes');
...
// ✅ place content write gate where you want to protect mutating admin ops
app.use(contentWriteGate());

// ✅ NEW admin accounts endpoints (used by Admin Users UI)
